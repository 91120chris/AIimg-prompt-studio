...
- FLUX.2 Klein 9B FP8 is large; the model card notes around 29GB VRAM for the 9B model. Use `FLUX_DEVICE_MAP` and `FLUX_TORCH_DTYPE` in `.env` to adjust local loading behavior.
